...
interface CryptoCurrencyInputProps {
  label?: string;
  name: string;
  currencyName: string;
  value?: string;
      ...
      <div className="relative bg-white rounded-[24px] border border-[#E0E0E0] overflow-hidden py-2 px-1">
        ...
        <div className="flex items-center h-full pr-2">
          ...
          >
            <SelectTrigger
              className={cn(
                "h-[44px] shadow-none focus:ring-0 focus:ring-offset-0 px-3 py-0 rounded-full! bg-[#f7f7f7]! text-xs! border border-[#E0E0E0]! ring-0! outline-none! focus-visible:ring-0! focus-visible:ring-offset-0! focus-visible:!border-none!",
            ...
            >
              <div className="flex items-center gap-1.5">
                {selectedCurrency?.icon && (
                  <span className="text-base flex items-center justify-center size-4 shrink-0">
